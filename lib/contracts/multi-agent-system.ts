...
export const AGENT_ENGINE_OPTIONS: AgentEngineOption[] = [
  ...
  },
  {
    ...
    nameFa: '🛡️ سپر دوگانه: منتقد قطعی S0 + ابرقدرت ۱۴B DeepSeek-R1',
    type: 'NEURAL_WEBGPU',
    latencyMs: 70,
    descriptionFa: 'حفاظت ریاضی قطعی همراه با غول استدلال ۱۴ میلیاردی DeepSeek برای دستگاه‌های با رم ۱۶ گیگابایت (Pixel Fold و اسنپ‌دراگون).',
  },
  {
